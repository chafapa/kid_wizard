...
<head>
    ...
    <title>Kid Wizard- User Home</title>
...
<body>
    ...
    <section class="home" id="home">
        ...
        <div class="content">
            <h3>Get started on a <span>Project of your choice</span></h3>
            <p>Explore, Learn, Grow</p>
            <a href="../view/project_categories.php" class="btn">View Project Categories</a>
        </div>
